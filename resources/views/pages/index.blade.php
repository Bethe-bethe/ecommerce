...
$total=BooksController::cartitem();
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <head>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>Bethe Book <em>Store</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                @can('create')
                <li class="nav-item"><a class="nav-link" href="{{route('create')}}">Add</a></li>
                @endcan
                <li class="nav-item"><a class="nav-link" href="{{route('cartlist')}}">cart({{$total}})</a></li>
                @if (Route::has('login'))
   ...
   @endif
      ...
      <div class="owl-banner owl-carousel">
        <div class="banner-item-01">
          <div class="text-content">
            ...
            <h3>a room without a book is like a body without a soul</h3>
          </div>
        </div>
          ...
          <div class="col-md-4">
            <div class="product-item">
              ...
              <div class="down-content">
                <a href="{{route('show',$book->id)}}"><h4>{{$book->name}}</h4></a>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="right-image">
              <img src="assets/images/bookstore.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="services" style="background-image: url(assets/images/bookstore.jpg);">
